                ...
                >
                    ...
                    <div className={cls.container}>
                        <div className={'flex gap-2 mt-10'}>
                            <button className={`${ isRegister ? cls.solidBottom : cls.solidTransparent}`} onClick={handleRegisterClick}>Регистрация</button>
                            <button className={`${ isRegister ? cls.solidTransparent : cls.solidBottom }`} onClick={handleLoginClick}>Вход</button>
                        </div>
